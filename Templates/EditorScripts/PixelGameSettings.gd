...
func _run() -> void:
	...
	ProjectSettings.set("display/window/size/viewport_width", 180)
	ProjectSettings.set("display/window/size/viewport_height", 320)
	
	#Size of the window
	ProjectSettings.set("display/window/size/window_width_override", 360)
	ProjectSettings.set("display/window/size/window_height_override", 640)
